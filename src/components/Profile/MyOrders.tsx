...
import { Archive, ClipboardClock, PackageCheck } from 'lucide-react'
...
const MyOrders = () => {
  ...
  return (
    <div className="mt-10 mb-20 px-3">
      ...
      <h2 className="my-3 flex items-center gap-2 pl-3 font-bold">
        <PackageCheck />- Active orders
      </h2>
      <ActiveOrders userId={currentUser?.id} />
      <h2 className="mt-10 mb-3 flex items-center gap-2 pl-3 font-bold">
